            ...
            <Formik initialValues={{ email: "", password: "", name: "" }} onSubmit={(values) => userSignUp(values)} validationSchema={SignupSchema}>
              {({ errors, touched }) => (
                <Form className="flex flex-wrap flex-col justify-center items-center mb-3">
                  ...
                  {touched.name && errors.name && <div className=" text-red-600 text-left">{errors.name}</div>}
                  ...
                  {touched.password && errors.password && <div className=" text-red-600 text-left">{errors.password}</div>}
